...
class BlocCounterView extends StatelessWidget {
  ...
  void increaseBy(BuildContext context, [int value = 1]) {
    // context.read<CounterBloc>().add(CounterIncreased(value)); // Using "handler"
    context.read<CounterBloc>().increaseBy(value); // Using "method"
  }


  void reset(BuildContext context) {
    // context.read<CounterBloc>().add(const CounterReset()); // Using "handler"
    context.read<CounterBloc>().resetCounter(); // Using "method"
  }
